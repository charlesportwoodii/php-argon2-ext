...
The constant `HASH_ARGON2I` can also be aliased by `HASH_ARGON2`.
...
### Hash Generation
```php
argon2_hash(string $string [, const $algorithm = HASH_ARGON2I] [, array $options ]);
```
